(function () {
  ...
  (function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object') module.exports = factory(require("ng.common"), require("ngxtranslate"), require("shared"), require("ng.core"));else if (typeof define === 'function' && define.amd) define(["ng.common", "ngxtranslate", "shared", "ng.core"], factory);else if (typeof exports === 'object') exports["container"] = factory(require("ng.common"), require("ngxtranslate"), require("shared"), require("ng.core"));else root["container"] = factory(root["ng.common"], root["ngxtranslate"], root["shared"], root["ng.core"]);
    ...
    return (
      ...
      /******/
      {
        ...
        function yT8(module, __webpack_exports__, __webpack_require__) {
          ...
          var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__);
          /* harmony import */


          var shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! shared */
          "cfyg");
          /* harmony import */


          var shared__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(shared__WEBPACK_IMPORTED_MODULE_2__);

          var ContainerComponent = /*#__PURE__*/function () {
            function ContainerComponent(iframeChatService, confirmationDialogService, translateService) {
            ...
            _createClass(ContainerComponent, [{
              key: "moveup",
              value: function moveup(elementInfo) {
              ...
              key: "movedown",
              value: function movedown(elementInfo) {
                elementInfo.parent.inParentIndex += 1;
                return this.iframeChatService.childAPI.moveToIndex(elementInfo.id, elementInfo.parent.inParentIndex);
              }
            }, {
              ...
              key: "del",
              value: function del(elementInfo) {
                var _this = this;

                return this.confirmationDialogService.confirm(this.translateService.instant('Please confirm'), this.translateService.instant('Do you want to Del') + ' ' + elementInfo.type).then(function (result) {
                  if (!result) {
                    return false;
                  }

                  return _this.iframeChatService.childAPI.Del(elementInfo.id);
                });
              }
            }]);
          ...
          (function () {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ContainerComponent, [{
              ...
              return [{
                type: shared__WEBPACK_IMPORTED_MODULE_2__["IFrameChatService"]
              }, {
                type: shared__WEBPACK_IMPORTED_MODULE_2__["ConfirmationDialogService"]
              }, {
