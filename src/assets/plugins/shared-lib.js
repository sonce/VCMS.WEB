    ...
    return (
      ...
      /******/
      {
        ...
        function m1yc(module, __webpack_exports__, __webpack_require__) {
          ...
          var penpal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! penpal */
          "mBXr");
          /* harmony import */


          var penpal__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(penpal__WEBPACK_IMPORTED_MODULE_7__);
          ...
          var RadiogroupComponent = /*#__PURE__*/function () {
            ...
            _createClass(RadiogroupComponent, [{
              ...
              value: function ngOnInit() {
                ...
                this.getClasses().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (x) {
                  _this.classes = x;
              ...
              value: function ngAfterViewInit() {
                ...
                Promise.resolve(null).then(function () {
                  return _this2.isInit = true;
                });
                this.radios.forEach(function (x) {
                  return x.toggleCheck.subscribe(_this2.onToggleCheck.bind(_this2));
                });
              }
            }, {
              key: "getClasses",
              value: function getClasses() {
                return this.skinObservable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (x) {
                  return x.split('-');
                }));
              }
            }, {
            ...
            _createClass(IFrameChatService, [{
              ...
              value: function Init(iframe, parentAPI) {
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.connection.promise).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (child) {
                  _this3.childAPI = Object.assign(Object.assign({}, child), _this3.childEvents);
                  _this3.hadInit = true;

                  _this3.onConnected.emit(true);
                })).subscribe();
              }
            }, {
              key: "destroy",
          ...
          var sharedComponents = [RadiogroupComponent, RadiogroupItemComponent, HelloComponent, SharedComponent, ButtonComponent, TabComponent, TabsComponent, ConfirmationDialogComponent];
          ...
          (function () {
            (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SharedModule, {
              declarations: function declarations() {
                return [RadiogroupComponent, RadiogroupItemComponent, HelloComponent, SharedComponent, ButtonComponent, TabComponent, TabsComponent, ConfirmationDialogComponent];
              },
